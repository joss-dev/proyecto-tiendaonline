...
<div class="container text-center">
    ...
    <div class="accordion accordion-flush" id="accordionExample">
        ...
        <div class="accordion-item my-5">
            <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    Seccion 2 - Adhesion junto con la politica de privacidad
                </button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de tecno phone.
                </div>
            </div>
        </div>
        <div class="accordion-item my-5">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    En general, el acceso al sitio web de tecno phone es gratuito y no requiere registro previo.
        ...
        <div class="accordion-item my-5">
            ...
            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    El funcionamiento de este sitio web es por tiempo ilimitado.
                    La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por tecno phone, en cualquier momento y sin previo aviso.
                </div>
            </div>
        </div>
        <div class="accordion-item my-5">
            ...
            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por tecno phone y/o los Socios. Las normas relativas al tratamiento de los datos personales de tecno phone están estipuladas en la Política de Privacidad.
                </div>
            </div>
        </div>
        <div class="accordion-item my-5">
            ...
            <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico tecnophone@gmail.com.
                </div>
            </div>
        </div>
    </div>
